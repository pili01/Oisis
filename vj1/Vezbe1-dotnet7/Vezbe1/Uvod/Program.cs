...
namespace Uvod
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string korisnickoPrezime = Console.ReadLine();

            Console.WriteLine("Unesite grad: ");
            string grad = Console.ReadLine();

            Console.WriteLine("Unesite omiljenu boju: ");
            ...
            int god = Convert.ToInt32(godina);
            ...
            Console.WriteLine("Korisnicko prezime je: " + korisnickoPrezime);

            Console.WriteLine("Grad je: " + grad);
            Console.WriteLine("Grad ispisan velikim slovima: " + grad?.ToUpper());

            Console.WriteLine("Omiljena boja je: " + boja);
            Console.WriteLine("omiljena boja ispisana malim slovima: " + boja?.ToLower());

            Console.WriteLine("Godina rodjenja je: " + god);
